...
public class IntegrationInterface {
            ...
            switch (userChoice) {
                ...
                case 2:
                    ...
                    while (!createdAccount) {
                        ...
                        boolean isValidAccount = moduleHub.registerUser(registerUsername, registerPassword, registerSecretQuestion, registerSecretAnswer);
                        if (!isValidAccount) {
                        	clearConsole();
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        IntegrationInterface applicationInterface = new IntegrationInterface();
